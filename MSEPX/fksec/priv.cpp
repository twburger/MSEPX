...
/*! \file priv.cpp
\brief contains the implementation of fksec::priv, the privilege wrapper class. */
...
{
	try { closeToken(); }
	catch ( ex *e ) { delete e; } // eat exceptions
}
...
bool priv::SetState( bool newState )
{
	...
	// unreachable code -- but VC 5.0 complains if this is absent
	return false;
}
